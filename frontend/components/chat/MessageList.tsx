...
export function MessageList({
  ...
  const { isPinned, togglePin } = usePinnedMessages(gid);
        ...
        {visible.map((msg) => {
          ...
          return (
            <MessageItem
              ...
              onTogglePin={isLeader ? (mid) => void togglePin(mid) : undefined}
              onAnnounce={isLeader ? (mid) => void announce(gid, mid) : undefined}
            />
          );
        })}
      </div>
